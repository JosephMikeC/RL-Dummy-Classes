...
struct ServerResult
{
 ...
 structdefaultproperties
 {
     IP=""
     ServerName=""
     Settings=(GameTags="",MapName=None,GameMode=0,MaxPlayerCount=0,ServerName="",Password="",bPublic=false)
 }
};

struct SkillGamePlayer
{
 var int PlayerID;
 var int Team;
...
var delegate<KeyPressDelegate> __KeyPressDelegate__Delegate;
var delegate<OnPriviledgeChecked> __OnPriviledgeChecked__Delegate;
...
delegate OnPriviledgeChecked(PrivilegeCheck_X PrivilegeCheck)
{
 //return;    
}